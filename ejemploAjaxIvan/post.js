window.onload=()=>{
    ...
    var formularioGet = document.getElementById('formEnviadoPost');
  ...
  function enviarXget(evento){
        ...
        let fd = new FormData();
        //añadimos los datos al form data
        ...
        ajax.open('POST', 'probando.php?usuario='+usuario+'&pass='+pass+'&clave='+clave,true);
