...
<body style="background-color: #c5e5ff;">
    ...
    <section>
        <div class="contenedorForm">
            <form action="validaLogin.php" method="POST" class="form" id="formRols">
                ...
                <div class="form_container">
                    ...
                    <input type="submit" class="form_submit2" value="Ingresar" name="loginUsers" id="submitRols">
            ...
            <script>
                //maneja el token del recaptcha
                function onClick(e) {
                    e.preventDefault();
                    grecaptcha.ready(function() {
                        grecaptcha.execute('6Leot9kiAAAAAKK2crAQQAS6-M5Wl2vO8VuOtU8x', {
                            action: 'submit'
                        }).then(function(token) {
    ...
    <!-- js maneja el crud dinamicamente -->
    <script src="validarFormRols.js"></script>
</body>
