...
if(isset($_POST['loginGoogle'])){
    //recuperamos datos que llegan por post
    $correo= $_POST['correo'];
    $pasUsr= $_POST['pass'];
    validaGoogle($correo, $pasUsr);
    

}
//Validamos si se ha pulsado el boton submit nombrado: registraEst
if (isset($_POST["al_ingreso"])) {
...
function validaLogAlumno($correo, $pasUsr)
{
    try {
        ...
        if ($registro["pass"] == $pasUsr and $registro["pass"] == $pasUsr) {
            ...
            header("location:../user_alumno/index.php");
        } else {
...
function validaGoogle($correo, $pasUsr)
{
    try {
