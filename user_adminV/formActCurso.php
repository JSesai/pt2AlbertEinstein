    ...
    <div class="container">
        ...
        <div class="contenedorForm">
            ...
            <form action="subirCurso.php" method="POST" enctype="multipart/form-data" class="formulario">
                ...
                <h2 class="titulo_fomulario">Actualizar Curso</h2>
                <div class="form_container">
                    ...
                    <div class="formBloque">
                        ...
                        <input type="file" class="inputForm" name="imagenCurso" placeholder=" " id="form_file">
                        <span class="form_line"></span>
                        <br>
                    </div>
                    ...
                    <div class="botons">
                        ...
                        <input type="submit" class="btn_submit" value="Actualizar " name="actualizaCurso">
                    </div>
                </div>
            </form>
        </div>
