        ...
        <div class="menu" style="background-color: #1A3C40;">
            <nav style="background-color: #1A3C40;">
                ...
                <ul class="items" style="background-color: #1A3C40;">
                    ...
                    <li class="itemMenu"><a href="aula.php">Inicio</a></li>
        ...
        <div class="cardCurso">
            ...
            foreach ($registros as $tema) : ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="imagenCurso"><a href="catalogo.php"><img src="../img/<?php echo $tema->img_tema ?>" alt="Imagen Tema" class="imgcard"></a>
                        </div>
